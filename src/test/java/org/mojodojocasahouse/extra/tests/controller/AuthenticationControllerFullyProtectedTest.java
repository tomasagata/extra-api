...
public class AuthenticationControllerFullyProtectedTest {
    ...
    @Test
    @WithMockUser
    public void testAccessingFullyProtectedResourceWithValidCredentialsIsSuccessful() throws Exception {
        // Setup - data
    ...
    @Test
    public void testAccessingFullyProtectedResourceWithInvalidUsernameAndEmailThrowsError() throws Exception {
        // Setup - data
    ...
    @Test
    public void testAccessingFullyProtectedResourceWithInvalidCookieThrowsError() throws Exception {
        // Setup - data
        ApiError expectedError = new ApiError(
                HttpStatus.UNAUTHORIZED,
                "Authentication Error",
    ...
    @Test
    @WithAnonymousUser
    public void testAccessingFullyProtectedResourceWithNoAuthenticatingCredentialsThrowsError() throws Exception {
        // Setup - data
        ApiError expectedError = new ApiError(
                HttpStatus.UNAUTHORIZED,
                "Authentication Error",
